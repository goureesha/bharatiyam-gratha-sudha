  ...
  categories: {
    ...
    gods: {
      ...
      subcategories: [
        ...
        { id: 'devi', title: 'ದೇವಿ', titleEn: 'Devi', icon: '🪔' },
        { id: 'ganesha', title: 'ಗಣೇಶ', titleEn: 'Lord Ganesha', icon: '🐘' },
        { id: 'hanuman', title: 'ಹನುಮಂತ', titleEn: 'Lord Hanuman', icon: '🐒' },
        { id: 'surya', title: 'ಸೂರ್ಯ', titleEn: 'Lord Surya', icon: '☀️' },
        { id: 'krishna', title: 'ಕೃಷ್ಣ', titleEn: 'Lord Krishna', icon: '🦚' },
        { id: 'rama', title: 'ರಾಮ', titleEn: 'Lord Rama', icon: '🏹' },
      ],
    },
    stotras: {
